...
public class AvroStationsAffectedByCount extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public velibstreaming.avro.record.source.AvroBicycleCount count;
   ...
   */
  public AvroStationsAffectedByCount(java.util.List<java.lang.String> stationCodes, velibstreaming.avro.record.source.AvroBicycleCount count) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: count = (velibstreaming.avro.record.source.AvroBicycleCount)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public velibstreaming.avro.record.source.AvroBicycleCount getCount() {
    return count;
  }
   ...
   * @param value the value to set.
   */
  public void setCount(velibstreaming.avro.record.source.AvroBicycleCount value) {
    this.count = value;
  }
   ...
   */
  public static velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder newBuilder() {
    return new velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder();
  }
   ...
   * @return A new AvroStationsAffectedByCount RecordBuilder
   */
  public static velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder newBuilder(velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder other) {
    if (other == null) {
      return new velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder();
    } else {
      return new velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder(other);
    }
  }
   ...
   * @return A new AvroStationsAffectedByCount RecordBuilder
   */
  public static velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder newBuilder(velibstreaming.avro.record.stream.AvroStationsAffectedByCount other) {
    if (other == null) {
      return new velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder();
    } else {
      return new velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroStationsAffectedByCount>
    ...
    private velibstreaming.avro.record.source.AvroBicycleCount count;
    private velibstreaming.avro.record.source.AvroBicycleCount.Builder countBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder other) {
      super(other);
      ...
      if (other.hasCountBuilder()) {
        this.countBuilder = velibstreaming.avro.record.source.AvroBicycleCount.newBuilder(other.getCountBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(velibstreaming.avro.record.stream.AvroStationsAffectedByCount other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.stationCodes)) {
        this.stationCodes = data().deepCopy(fields()[0].schema(), other.stationCodes);
    ...
    /**
      ...
      * @return This builder.
      */
    public velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder setStationCodes(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder clearStationCodes() {
      stationCodes = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder setCount(velibstreaming.avro.record.source.AvroBicycleCount value) {
     ...
     * @return This builder.
     */
    public velibstreaming.avro.record.source.AvroBicycleCount.Builder getCountBuilder() {
      if (countBuilder == null) {
        if (hasCount()) {
          setCountBuilder(velibstreaming.avro.record.source.AvroBicycleCount.newBuilder(count));
        } else {
          setCountBuilder(velibstreaming.avro.record.source.AvroBicycleCount.newBuilder());
        }
      }
      return countBuilder;
    }
     ...
     * @return This builder.
     */
    public velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder setCountBuilder(velibstreaming.avro.record.source.AvroBicycleCount.Builder value) {
      clearCount();
      countBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public velibstreaming.avro.record.stream.AvroStationsAffectedByCount.Builder clearCount() {
      count = null;
      countBuilder = null;
    ...
    public AvroStationsAffectedByCount build() {
      try {
        ...
        if (countBuilder != null) {
          ...
          record.count = fieldSetFlags()[1] ? this.count : (velibstreaming.avro.record.source.AvroBicycleCount) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.count == null) {
          this.count = new velibstreaming.avro.record.source.AvroBicycleCount();
        }

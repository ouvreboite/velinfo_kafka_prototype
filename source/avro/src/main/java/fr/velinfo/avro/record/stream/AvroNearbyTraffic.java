...
public class AvroNearbyTraffic extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<fr.velinfo.avro.record.source.AvroBicycleCount> counts;
   ...
   */
  public AvroNearbyTraffic(java.lang.String stationCode, java.lang.Integer totalTraffic, java.lang.Long periodStart, java.lang.Long periodEnd, java.util.List<fr.velinfo.avro.record.source.AvroBicycleCount> counts) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: counts = (java.util.List<fr.velinfo.avro.record.source.AvroBicycleCount>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.List<fr.velinfo.avro.record.source.AvroBicycleCount> getCounts() {
    return counts;
  }
   ...
   * @param value the value to set.
   */
  public void setCounts(java.util.List<fr.velinfo.avro.record.source.AvroBicycleCount> value) {
    this.counts = value;
  }
   ...
   */
  public static fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder newBuilder() {
    return new fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder();
  }
   ...
   * @return A new AvroNearbyTraffic RecordBuilder
   */
  public static fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder newBuilder(fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder other) {
    if (other == null) {
      return new fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder();
    } else {
      return new fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder(other);
    }
  }
   ...
   * @return A new AvroNearbyTraffic RecordBuilder
   */
  public static fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder newBuilder(fr.velinfo.avro.record.stream.AvroNearbyTraffic other) {
    if (other == null) {
      return new fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder();
    } else {
      return new fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroNearbyTraffic>
    ...
    private java.util.List<fr.velinfo.avro.record.source.AvroBicycleCount> counts;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(fr.velinfo.avro.record.stream.AvroNearbyTraffic other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.stationCode)) {
        this.stationCode = data().deepCopy(fields()[0].schema(), other.stationCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder setStationCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder clearStationCode() {
      stationCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder setTotalTraffic(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder clearTotalTraffic() {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder setPeriodStart(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder clearPeriodStart() {
      periodStart = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder setPeriodEnd(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder clearPeriodEnd() {
      periodEnd = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder setCounts(java.util.List<fr.velinfo.avro.record.source.AvroBicycleCount> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.stream.AvroNearbyTraffic.Builder clearCounts() {
      counts = null;
    ...
    public AvroNearbyTraffic build() {
      try {
        ...
        record.counts = fieldSetFlags()[4] ? this.counts : (java.util.List<fr.velinfo.avro.record.source.AvroBicycleCount>) defaultValue(fields()[4]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (fr.velinfo.avro.record.source.AvroBicycleCount e0: this.counts) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<fr.velinfo.avro.record.source.AvroBicycleCount> a0 = this.counts;
      if (a0 == null) {
        a0 = new SpecificData.Array<fr.velinfo.avro.record.source.AvroBicycleCount>((int)size0, SCHEMA$.getField("counts").schema());
        this.counts = a0;
      } else a0.clear();
      SpecificData.Array<fr.velinfo.avro.record.source.AvroBicycleCount> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<fr.velinfo.avro.record.source.AvroBicycleCount>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          fr.velinfo.avro.record.source.AvroBicycleCount e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new fr.velinfo.avro.record.source.AvroBicycleCount();
          }
          e0.customDecode(in);
          a0.add(e0);
        }

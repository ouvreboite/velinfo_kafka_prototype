...
public class AvroBicycleCount extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1587859656976042836L;
   ...
   */
  public AvroBicycleCount(java.lang.String counterId, java.lang.Integer count, java.lang.Long countTimestamp, fr.velinfo.avro.record.source.AvroCoordinates coordinates) {
   ...
   */
  public static fr.velinfo.avro.record.source.AvroBicycleCount.Builder newBuilder() {
    return new fr.velinfo.avro.record.source.AvroBicycleCount.Builder();
  }
   ...
   * @return A new AvroBicycleCount RecordBuilder
   */
  public static fr.velinfo.avro.record.source.AvroBicycleCount.Builder newBuilder(fr.velinfo.avro.record.source.AvroBicycleCount.Builder other) {
    if (other == null) {
      return new fr.velinfo.avro.record.source.AvroBicycleCount.Builder();
    } else {
      return new fr.velinfo.avro.record.source.AvroBicycleCount.Builder(other);
    }
  }
   ...
   * @return A new AvroBicycleCount RecordBuilder
   */
  public static fr.velinfo.avro.record.source.AvroBicycleCount.Builder newBuilder(fr.velinfo.avro.record.source.AvroBicycleCount other) {
    if (other == null) {
      return new fr.velinfo.avro.record.source.AvroBicycleCount.Builder();
    } else {
      return new fr.velinfo.avro.record.source.AvroBicycleCount.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroBicycleCount>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(fr.velinfo.avro.record.source.AvroBicycleCount.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(fr.velinfo.avro.record.source.AvroBicycleCount other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.counterId)) {
        this.counterId = data().deepCopy(fields()[0].schema(), other.counterId);
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.source.AvroBicycleCount.Builder setCounterId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.source.AvroBicycleCount.Builder clearCounterId() {
      counterId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.source.AvroBicycleCount.Builder setCount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.source.AvroBicycleCount.Builder clearCount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.source.AvroBicycleCount.Builder setCountTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.source.AvroBicycleCount.Builder clearCountTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.source.AvroBicycleCount.Builder setCoordinates(fr.velinfo.avro.record.source.AvroCoordinates value) {
     ...
     * @return This builder.
     */
    public fr.velinfo.avro.record.source.AvroBicycleCount.Builder setCoordinatesBuilder(fr.velinfo.avro.record.source.AvroCoordinates.Builder value) {
      clearCoordinates();
    ...
    /**
      ...
      * @return This builder.
      */
    public fr.velinfo.avro.record.source.AvroBicycleCount.Builder clearCoordinates() {
      coordinates = null;
